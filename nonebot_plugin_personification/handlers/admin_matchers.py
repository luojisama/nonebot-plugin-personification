...
def register_admin_matchers(
    *,
    ...
    enable_personification = _register_command("开启拟人", aliases={"拟人开启"}, permission=superuser_permission, priority=5, block=True)
    disable_personification = _register_command("关闭拟人", aliases={"拟人关闭"}, permission=superuser_permission, priority=5, block=True)
