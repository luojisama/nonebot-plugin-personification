...
const staticRoot = path.join(root, "nonebot_plugin_personification", "webui", "static");
const core = fs.readFileSync(path.join(staticRoot, "app-core.js"), "utf8");
const admin = fs.readFileSync(path.join(staticRoot, "app-qzone.js"), "utf8");
